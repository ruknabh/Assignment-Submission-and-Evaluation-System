    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col shrink-0">
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          ...
          <SidebarLink to="/admin/dashboard"   icon={<DashboardIcon />}  label="Dashboard" />
          <SidebarLink to="/admin/enrollments" icon={<EnrollmentIcon />} label="Enrollments" />
          <SidebarLink to="/admin/users"       icon={<UsersIcon />}      label="Users" />
          <SidebarLink to="/admin/courses"     icon={<CoursesIcon />}    label="All Courses" />
        </nav>
