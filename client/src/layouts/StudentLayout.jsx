      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col shrink-0">
        ...
        <div className="h-16 flex items-center gap-3 px-5 border-b border-gray-200">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 leading-tight">Student Portal</p>
          </div>
        </div>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          ...
          <SidebarLink to="/student/dashboard" icon={<DashboardIcon />} label="Dashboard" />
          <SidebarLink to="/student/grades"    icon={<GradesIcon />}    label="My Grades" />
        </nav>
